...
<script>
    $(function () {
        ...
        function topicFun(data_index){
            ...
            $("#imgUrl").attr("src",data[data_index].url);
        }
        function textFun(ans, ans1) {
            if(ans == "Q"){
                ansText.push(data[data_index].Qurl)
            }else if(ans=="P"){
                ansText.push(data[data_index].Purl)
            }else if(ans=="A"){
                ansText.push(data[data_index].Aurl)
            }else if(ans=="B"){
                ansText.push(data[data_index].Burl)
            }else if(ans=="C"){
                ansText.push(data[data_index].Curl)
            }else if(ans=="D"){
                ansText.push(data[data_index].Durl)
            }else if(ans=="E"){
                ansText.push(data[data_index].Eurl)
            }else if(ans=="F"){
                ansText.push(data[data_index].FText)
            }
            if(ans1 == "Q"){
                buttonsetText.push(data[data_index].Qurl)
            }else if(ans1=="P"){
                buttonsetText.push(data[data_index].Purl)
            }else if(ans1=="A"){
                buttonsetText.push(data[data_index].Aurl)
            }else if(ans1=="B"){
                buttonsetText.push(data[data_index].Burl)
            }else if(ans1=="C"){
                buttonsetText.push(data[data_index].Curl)
            }else if(ans1=="D"){
                buttonsetText.push(data[data_index].Durl)
            }else if(ans1=="E"){
                buttonsetText.push(data[data_index].Eurl)
            }else if(ans1=="F"){
                buttonsetText.push(data[data_index].Furl)
            }
        }
        ...
        function topicResultFun(arr) {
            for (var i = 0; i < arr.length; i++) {
                $("#topic_result").append(
                    ...
                    '<td><img src="'+ansText[i]+'" alt="" style="height: 120px;width: auto;"></td>' +
                    '<td><img src="'+buttonsetText[i]+'" alt="" style="height: 120px;width: auto;"></td>' +
                    '<td>'+timeset[i]+'</td>' +
                    '</tr>'
                )
            }
