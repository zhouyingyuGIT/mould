            ...
            <div class="item2_ans_box" style="">
                <div class="item2_fiex" style="">
                    <div class="item2_item">
                        <img src="A.png" alt="">
                        <div data-data="A" class="item2_set" id="item2_A">A</div>
                    </div>
                </div>
                ...
                <div class="item2_fiex" style="">
                    <div class="item2_item">
                        <img src="B.png" alt="">
                        <div data-data="B" class="item2_set" id="item2_B">B</div>
                    </div>
                </div>
                ...
                <div class="item2_fiex" style="">
                    <div class="item2_item">
                        <img src="C.png" alt="">
                        <div data-data="C" class="item2_set" id="item2_C">C</div>
                    </div>
                </div>
                ...
                <!--<div class="item2_fiex" style="">
                    <div class="item2_item">
                        <img src="xx.jpg" alt="">
                        <div data-data="D" class="item2_set" id="item2_D">D</div>
                    </div>
                </div>-->
            </div>
        </div>
