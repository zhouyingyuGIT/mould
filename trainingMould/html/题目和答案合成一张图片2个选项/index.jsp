...
<div id="box">
    ...
    <div id="item2" class="item hide" style="background: #afdcff;">
        <div class="item" style="display: flex;align-items:center;justify-content:center;background-image: url('timg.gif');background-size: 100% 100%;">
            <div style="display: flex;align-items:center;justify-content:center;height: 100%;width: 68%;">
...
<script>
    $(function () {
        ...
        var data_index=0,correct_number=0,great=0,data_number=0;
