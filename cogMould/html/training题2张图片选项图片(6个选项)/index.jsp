...
<div id="box">
    ...
    <div id="item2" class="item item2 hide">
        <div class="div-flex" style="height: 100%;margin-right: 140px">
            <div class="item item2_box">
                <div class="item2_topic">
                    <div id="topic" class="item2_ti">
                        <div style="width: 30%">
                            <img id="topic_img1" src="" alt="">
                        </div>
                        <div style="width: 70%">
                            <img id="topic_img2" src="" alt="">
                        </div>
                    </div>
                </div>
...
<script>
    $(function () {
        ...
        var type4set=[],stimidset=[],correctanswerset=[],buttonset=[],timeset=[],commentset=[],feedbackArr=[];
        pushArr(data);
        ...
        function topicResultFun(arr) {
            for (var i = 0; i < arr.length; i++) {
                ...
                topicCon='<img src="'+arr[i].url2+'" alt=""><img src="'+arr[i].url1+'" alt="">';
